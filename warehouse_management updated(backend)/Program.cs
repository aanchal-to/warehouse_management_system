...
builder.Services.AddTransient<ISupplierOrderSer, SupplierOrderSer>();
builder.Services.AddScoped<IGoodRepo, GoodRepo>();
builder.Services.AddTransient<IGoodSer, GoodSer>();
builder.Services.AddScoped<IInvSupRepo, InvSupRepo>();
builder.Services.AddTransient<IInvSupSer, InvSupSer>();
