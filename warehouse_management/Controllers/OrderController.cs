...
namespace warehouse_management.Controllers
{
    ...
    public class OrderController :ControllerBase
    {
        ...
        [HttpGet("customers/matching/{itemName}/{quantity}")]
        public async Task<ActionResult<IEnumerable<Order>>> GetMatchingOrder(string itemName, int quantity)
        {
            var matchingOrders = await _orderService.GetOrderByItemAndQuantityAsync(itemName, quantity);
